...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="../xsl/glossary-generation.xsl"/>
  ...
  <xsl:template match="/">
    ...
    <xsl:variable name="generated-map">
      <xsl:apply-templates select="." mode="dita-community:glossary-generate">
    ...
    <xsl:variable name="testResult">
      <test-result>
        <generated-map>
          <xsl:sequence select="$generated-map"/>
        </generated-map>
      </test-result>
    </xsl:variable>
